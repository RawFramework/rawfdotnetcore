...
<div id="#{name_downcase}_template">
    ...
    <script>
        require(["/js/app/#{name}.controller.js", "/js/app/#{name}.binding.js", "/js/app/#{name}.validate.js", 'utils','typeahead'], function (#{name_downcase}Controller, appViewModel, formValidator, utils, type) {
            utils.spinner.show();
