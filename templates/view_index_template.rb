...
<div id="#{name_downcase}_template" class="hidden">
    ...
    <script>
        require(["/js/app/#{name}.controller.js", "/js/app/#{name}.binding.js", 'moment', 'utils', 'underscore' #{grid_file if use_bs_grid}], function (#{name_downcase}Controller, appViewModel, moment, utils, _) {
            utils.spinner.show();
